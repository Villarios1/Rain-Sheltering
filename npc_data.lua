...
M.saveNpcShelterState = function(npc, cellKey, shelterPoint)
	...
	log:debug("originPackage.type: %s", originAiPackage.type)
	local originIdles = {}
	...
	else -- idles is nil due to AItravel
		log:debug("\nBug in saveNpcShelterState originAiPackage: %s,\n%s,\n%s", originAiPackage and originAiPackage.type, originAiPackage.idles, npc.mobile.aiPlanner)
		log:debug("\nPlanner: %s", npc.mobile.aiPlanner.currentPackageIndex)
	end
